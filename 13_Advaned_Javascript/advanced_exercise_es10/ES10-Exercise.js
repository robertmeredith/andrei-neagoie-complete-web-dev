...
const greetingString = greeting.flatMap(x => x.join(' ').join(' '));
...
const cleanedEmail = userEmail3.trimStart().trimEnd();
...
const usersObject = Object.fromEntries(updatedUsersArray);